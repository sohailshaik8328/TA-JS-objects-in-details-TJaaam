...
myFunction(); // It will point to window due to explicit binging;
...
myObject.someMethod(); // someMethod
...
console.log(getSecondData()); // 2 Because we are binding the function from obj2
